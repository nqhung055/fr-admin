...
const mutations = {
    ...
    loginUserSuccess(state, user) {
        ...
        // router.push("/default/dashboard/detection-logs.html");
        // router.push("/default/dashboard/visitors-report.html");
        router.push("/default/dashboard/general-dashboard.html");
