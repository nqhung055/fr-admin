...
export default {
  ...
  viewDetectionLogs: 'View Detection Logs',
  strangerAndEmployeeStatistics: 'Registered user & Guest Statistics',
  bodyAndRoomTemperatures: 'Body & Room Temperatures',
  ...
  visitorCollection: 'Total Traffic',
  visitorsummaries: 'Entry Summary',
  temperatureScreening: 'Failed Scanning Traffic',
  ...
  visitorMonthly: 'Entry Registered User Vs Guest Visitors Monthly Statistics',
  visitorDaily: 'Entry Registered User Vs Guest Visitors Daily Statistics',
  visitorHourly: 'Entry Registered User Vs Guest Visitors Hourly Statistics',
  monthlyStatistics: 'Monthly percentage statistics',
  dailyStatistics: 'Daily percentage statistics',
  hourlyStatistics: 'Hourly percentage statistics',
  employee: 'Registered User',
  stranger: 'Guest Entries',
  totalVisitors: 'Total Entries',
  totalEmployee: 'Total Registered Users',
  totalStranger: 'Total Guests',
  temperature: 'Temperature',
  pass: 'Passed Registered User Entries',
  failed: 'Failed Registered User Entries',
  guestPass: 'Passed Guest Entries',
  guestFailed: 'Failed Guest Entries',
  totalPassVsFail: 'Total screening',
  totalScreeningPassed: 'Total Screening Passed',
  totalScreeningFailed: 'Total Screening Failed',
  ...
  star: '******',
  inout:'IN/OUT',
  downloadExcelFile:'Export User Data'
}