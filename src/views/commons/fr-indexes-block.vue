<template>
  <v-row>
    <v-col xl="3" lg="3" md="6" sm="12" cols="6" class="stats-widget-v3">
      <!--  +5% from yesterday -->
      <index-stats :title="$t('message.employee')" :value="this.usersPerDay" :body="this.usersYtd" :status="this.usersPerDay >= this.usersYtd ? 1 : 0"></index-stats>
    </v-col>
    <v-col xl="3" lg="3" md="6" sm="12" cols="6" class="stats-widget-v3">
      <index-stats :title="$t('message.stranger')" :value="this.guestsPerDay" :body="this.guestsYtd" :status="this.guestsPerDay >= this.guestsYtd ? 1 : 0"></index-stats>
    </v-col>
    <v-col xl="3" lg="3" md="6" sm="12" cols="6" class="stats-widget-v3">
      <!-- -2% from yesterday -->
      <index-stats
